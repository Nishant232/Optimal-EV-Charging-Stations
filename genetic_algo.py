...
# --- LOAD DATA ---
data = pd.read_csv('./data/evcs_input_gurugram.csv')
...
if os.path.exists('./data/evcs_best_25_locations.csv'):
    os.remove('./data/evcs_best_25_locations.csv')
result.to_csv('./data/evcs_best_25_locations.csv', index=False)