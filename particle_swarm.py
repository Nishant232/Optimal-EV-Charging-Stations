...
# ---- Load Input Data ----
data = pd.read_csv('./data/evcs_input_50_locations.csv')
N = len(data)
...
if os.path.exists('./data/evcs_pso_selected_locations.csv'):
    os.remove('./data/evcs_pso_selected_locations.csv')
best_locs.to_csv('./data/evcs_pso_selected_locations.csv', index=False)
